...
public class TestTravel extends BasePage {
   ...
   @Test
    ...
    public void testSelectDepartingDate(){
        HomePage homePage = new HomePage();
        SelectFlight selectFlight = homePage.clickFlightPage();
        selectFlight.selectDepartingDate("December","2022",29);
        String text = "Dec 29";
    ...
    public void testSelectReturningDate(){
        HomePage homePage = new HomePage();
        SelectFlight selectFlight = homePage.clickFlightPage();
        selectFlight.selectReturningDate("January","2023",10);
        String text = "Jan 10";
    ...
    public void testSearchForFlight(){
        ...
        selectFlight.clickAndSendKeysGoingToButton("paris",1);
        selectFlight.selectDepartingDate("November","2022",25);
        selectFlight.selectReturningDate("September","2023",10);
        selectFlight.clickSearchButton();
        Assert.assertTrue(
                selectFlight.searchResultVerification("Denver (DEN) - Paris (CDG)"));
    }
